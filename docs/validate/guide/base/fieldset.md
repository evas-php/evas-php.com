...
|----------|-----|----------|--------------|
| 1 | *array* | маппинг валидаторов полей или параметров валидаторов полей по их именам | null |
| 2 | *array* | параметры валидатора набора полей | null |
...
| 2 | *bool* | проверять на все ошибки | null |
| 3 | *bool* | вызывается ли из родительского набора полей | null |
